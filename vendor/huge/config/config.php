 ...
 */
if(PRODUCAO){
    define("COOKIE_DOMAIN", "pfdimension.com.br");
}
else{
...
if (PRODUCAO) {
    define("EMAIL_USE_SMTP", true);
    define("EMAIL_SMTP_HOST", "pfdimension.com.br");
    define("EMAIL_SMTP_AUTH", true);
    define("EMAIL_SMTP_USERNAME", "no-reply@pfdimension.com.br");
    define("EMAIL_SMTP_PASSWORD", "Dimension2015");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", SITE_URL . "DIM.Gateway.php?arq=7&tch=2&sub=4&dlg=0");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@pfdimension.com.br");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Dimension");
define("EMAIL_PASSWORDRESET_SUBJECT", "Reiniciar senha - Dimension");
define("EMAIL_PASSWORDRESET_CONTENT", "Por favor, clique no link abaixo para reiniciar sua senha<br />");

/**
 * Configuration for: verification email data
 * Set the absolute URL to register.php, necessary for email verification links
 */
define("EMAIL_VERIFICATION_URL", SITE_URL . "DIM.Gateway.php?arq=8&tch=2&sub=4&dlg=0");
define("EMAIL_VERIFICATION_FROM", "no-reply@pfdimension.com.br");
define("EMAIL_VERIFICATION_FROM_NAME", "Dimension");
define("EMAIL_VERIFICATION_SUBJECT", "Ativa&ccedil;&atilde;o de conta - Dimension");
define("EMAIL_VERIFICATION_CONTENT", "Por favor, clique neste link para ativar a sua conta:");
