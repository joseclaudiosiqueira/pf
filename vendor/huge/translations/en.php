...
define("MESSAGE_IS_EXISTENTE", "There is a user registered in your organization with this informations (username, email)");
...
define("WORDING_REGISTRATION_COMPLETE_USERNAME", "Complete name)");
