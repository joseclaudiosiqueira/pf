...
$str_captcha = '';
$fnt_captcha = $_SERVER['DOCUMENT_ROOT'] . (substr($_SERVER['DOCUMENT_ROOT'], - 1) === '/' ? '' : '/') . 'pf/vendor/huge/tools/fonts/times_new_yorker.ttf';
...
for ($i = 0; $i < $iCaptchaLength; $i++) {
    ...
    imagefttext($im, 35, rand(-10, 10), 20 + ($i * 30) + rand(-5, +5), 35 + rand(10, 30), $text_color, $fnt_captcha, $str_captcha[$i]);
}
