...
class UploadHandlerFile
{
    ...
    protected $error_messages = array(
        ...
        'max_file_size' => 'O arquivo ultrapassa o tamanho contratado no plano',
        'min_file_size' => 'Arquivo muito pequeno menor que 1B',
        'accept_file_types' => 'Tipo de arquivo proibido',
        'max_number_of_files' => 'Quantidade de arquivos maior que a contratada no plano',
    ...
    {
        /*
         * mudanca para um diretorio seguro
         * 'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . '/files/' . sha1(getIdEmpresa()) . '/',
         * 'upload_url' => $this->get_full_url() . '/files/' . sha1(getIdEmpresa()) . '/', //Dimension
         */
        /*
         * Dimension crypto dos nomes dos arquivos
         */
        global $converter;
        //TODO: verificar criptografia
        //$file = $converter->encode(str_pad(getIdEmpresa(), 11, '0', STR_PAD_LEFT));
        //$cont = $converter->encode(str_pad(getIdContagem(), 11, '0', STR_PAD_LEFT));
        
        $file = str_pad(getIdEmpresa(), 11, '0', STR_PAD_LEFT);
        $cont = str_pad(getIdContagem(), 11, '0', STR_PAD_LEFT);
        
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url() . '/' . basename($this->get_server_var('SCRIPT_NAME')),
            'upload_dir' => DIR_FILE . str_pad(getIdEmpresa(), 11, '0', STR_PAD_LEFT) . '/' . str_pad(getIdContagem(), 11, '0', STR_PAD_LEFT) . '/',
            'upload_url' => '/pf/arquivos/download.php?a=' . $file . '/' . $cont . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'max_file_size' => getConfigPlano('upload'),
            'min_file_size' => 1,
            // The maximum number of files for the upload directory:
            'max_number_of_files' => getConfigPlano('quantidade_arquivos_contagem'),
    ...
    /*
     * Dimension
     * ver neste ponto a identificacao da contagem e do usuario
     */
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error, $index, $content_range)
    {
        ...
        /*
         * Dimension ... retirando acentos e espacos dos nomes dos arquivos
         */
        return $name;
    }
