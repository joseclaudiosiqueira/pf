...
//    function __destruct()
    ...
    /**
     * Return true with insert an image
     */
    public function insertLogo($idEmpresa, $idCliente) {
        /*
         * inserindo uma imagem apena para contagens nao Baseline e Licitacao
         */
        $logomarca = DIR_BASE
                . 'actions/relatorios/personalizados/'
                . sha1($idEmpresa) . '/'
                . sha1($idCliente) . '/'
                . sha1($idCliente) . '.png';
        /*
         * criando a imagem
         */
        $imgCliente = imagecreatefrompng($logomarca);
        /*
        ...
        $objImg->setImageResource($imgCliente)
                ...
                ->setWidth(268)
                ->setCoordinates('A1')
                ->setWorksheet($this->getActiveSheet());
    }
